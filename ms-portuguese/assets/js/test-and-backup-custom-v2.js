...
// when enter that time clodflare run that code availabe below 
// dont use this js 
...
// Load CAPTCHA only on interaction
function loadCaptcha() {
  if (!captchaLoaded) {
    window.turnstile.render('.cf-turnstile', {
      sitekey: '0x4AAAAAABMnlbntlIIuNV9l',
...
// Load CAPTCHA when user focuses the email input
document.querySelector(".subscribeEmailField").addEventListener("focus", loadCaptcha);
